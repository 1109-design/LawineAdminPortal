...
<div class="nav-header">
    <div class="brand-logo">
        <a href="index.html">
            <b class="logo-abbr"><img src="{{asset('assets/images/images/logo.png')}}" alt=""> </b>
                    ...
                    <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                        <div class="dropdown-content-body">
                            <ul>
                                ...
                                <li> <a class="icon-lock" href="{{ route('logout') }}"
...
<div class="nk-sidebar">
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
            <li class="nav-label">Manage Clients</li>
            <li>
                <a href="{{route('home')}}" aria-expanded="false">
                    <i class="icon-people menu-icon"></i><span class="nav-text">View All Clients</span>
                </a>
            </li>
            <li class="nav-label">Manage crashes</li>

            <li>
                <a href="{{route('crashes')}}" aria-expanded="false">
                    <i class="icon-map menu-icon"></i><span class="nav-text"> Crashes/Emergency Info</span>
                </a>
            </li>
